    ...
    <div class="min-h-[100vh] min-w-[100vw] bg-white dark:bg-gray-800 pt-12 dark:text-white ">
        <div class="min-w-full h-full bg-white dark:bg-gray-900 dark:text-white px-4 sm:px-6 lg:px-[5vw] pt-20 pb-40">
            ...
            <div class="flex gap-3 pt-4">
                            ...
                            <div
                                ...
                                <div class="flex gap-x-2">
                                    <button onclick="increaseQuantity({{ $product->id }})">
                                        ...
                                        <input type="number" id="quantity-{{ $product->id }}" value="1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-20 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John">
                ...
                <div class="w-1/2 bg-slate-100 dark:bg-slate-800 rounded-lg min-h-[300px]">
                    <div class="flex flex-col px-8 py-6  gap-10">
                        <h3>Order summary</h3>
