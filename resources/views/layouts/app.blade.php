    ...
    <div id="alert-container" class="fixed top-10 right-10 z-50">
      ...
      @if (session('success'))
        <div id="alert-success"
          class="flex items-center p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 alert"
          role="alert">
      ...
      @if ($errors->any())
        @foreach ($errors->all() as $k => $error)
          <div id="alert-{{ $k }}"
            class="flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 alert"
            role="alert">
            <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
              viewBox="0 0 20 20">
              <path
