            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
              <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                  <h3>To import excel file to batch increment stocks in warehouse, the excel file must
                    contains two
                    columns. "product_id" and "count"</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <thead class="text-xs text-gray-700 uppercase bg-gray-300 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            ...
            <th scope="col" class="px-6 py-3 text-center">
              Product <br /><span class="dark:text-neutral-300 text-gray-600 ">( {{ $totalProducts }} )</span>
            </th>
            <th scope="col" class="px-6 py-3 text-center">
              Total Quantity <br /><span class="dark:text-neutral-300 text-gray-600 ">( {{ $totalQty }}
                )</span>
            </th>
            <th scope="col" class="px-6 py-3 text-center">
              Available Quantity <br /><span class="dark:text-neutral-300 text-gray-600 ">(
                {{ $availableTotal }} )</span>
            </th>
