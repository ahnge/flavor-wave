    ...
    <div class=" mx-auto rounded-md mt-7">
      ...
      <form id="myForm" action="{{ route('warehouse.storeProduct') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="flex justify-start items-center gap-8">
          <div class="mb-4">
            <label for="product_photo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Product
              Photo</label>
        ...
        <button type="submit"
          ...
          <svg id="svgLoading" role="status" class="hidden w-4 h-4 me-3 text-gray-200 animate-spin dark:text-gray-600"
